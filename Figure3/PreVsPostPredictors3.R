...
sTable1p <- matrix(NA,nrow=4,ncol=4)
sTable2p <- matrix(NA,nrow=4,ncol=4)
...
sTable1p[1,4] <- results$coefficients[2,4]
...
sTable2p[1,4] <- results$coefficients[2,4]
...
cat("Number of observations : ", length(attending),"\n")
