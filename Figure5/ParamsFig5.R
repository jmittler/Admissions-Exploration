...
s1 <- 9.0; w1 <- 15.0; h1 <- 15.0; # GRE  
s2 <- 1.0; w2 <- 3.0; h2 <- 3.0; # GPA                      
s3 <- 1.0; w3 <- 1.0; h3 <- 1.0; # Research experience      
s4 <- 2.0; w4 <- 2.0; h4 <- 2.0; # Ability to work in lab (as assessed by LORs)
s5 <- 1.0; w5 <- 1.0; h5 <- 1.0; # Subtle / unquantifable factors correctly intuited by committee members  
s6 <- 0.0; w6 <- 1.0; h6 <- 1.0; # Irrelevant factors used by committee members
s7 <- 0.0; w7 <- 0.0; h7 <- 0.0; # Irrelevant factors used Harvard's admissions committee
s8 <- 4.0; w8 <- 0.0; h8 <- 0.0; # Chance effects
